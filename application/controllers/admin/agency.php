<?php
    ...
    {
        var $controller = 'agency';
        var $viewName = 'agency_view';
        var $table = 'users';
        var $data = array();
        ...
        function index()
        {
            $query            = "SELECT id, firstName as first_name, lastName as last_name, contactNo as contact_no, email, status FROM users WHERE userType = '2' AND `status` != '-1' ";
            $temp             = new template();
            $temp->query      = $query;
        ...
        function save_()
        {
            $insert = array('firstName' => $this->input->post('firstName'), 'lastName' => $this->input->post('lastName'), 'contactNo' => $this->input->post('contactNo'), 'email' => $this->input->post('email'), 'userType' => 2, 'createdAt' => time());
        ...
        function update_()
        {
            $update = array('firstName' => $this->input->post('firstName'), 'lastName' => $this->input->post('lastName'), 'contactNo' => $this->input->post('contactNo'), 'email' => $this->input->post('email'), 'userType' => 2, 'updatedAt' => time());
