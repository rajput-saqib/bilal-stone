<?php
    ...
    class Profile extends Admin_Controller
    {
        ...
        function view_()
        {
            ...
            header('Content-disposition: attachment; filename="backup_'.time().'.txt"');

            echo $this->savefile($data, $database);
        }
        ...
        function update_()
        {
            ...
            $update = array('username' => $this->input->post('username'), 'firstName' => $this->input->post('firstName'), 'lastName' => $this->input->post('lastName'), 'password' => $password, 'salt' => $salt, 'company_name' => $this->input->post('company_name'), 'per_page_rows' => $this->input->post('per_page_rows'));
