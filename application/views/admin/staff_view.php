            ...
            <form action="<?=$controllerName.$submitPath?>" method="post" id="my-form" style="padding: 20px 0 0 0" onsubmit="return formValidation(this.id)" class="form-horizontal" >
                <fieldset>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="title" id="title" value="<?=(isset($data->title) ? $data->title:'')?>" class="input-xlarge focused [c-e]" />
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="address" id="address" value="<?=(isset($data->address) ? $data->address:'')?>" class="input-xlarge focused [c-e]" />
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="mobile" id="mobile" value="<?=(isset($data->mobile) ? $data->mobile:'')?>" class="input-xlarge focused [c-e]" />
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="salary" id="salary" value="<?=(isset($data->salary) ? $data->salary:'')?>" class="input-xlarge focused [c-e]" />
                        </div>
                    </div>
