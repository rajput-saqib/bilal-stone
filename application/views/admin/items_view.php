        ...
        <div class="box-content">
            <form action="<?=$controllerName.$submitPath?>" method="post" id="my-form" style="padding: 20px 0 0 0" onsubmit="return formValidation(this.id)" class="form-horizontal" >
                <fieldset>
                    ...
                    <div class="control-group">
                        <label class="control-label">Quantity Per Bag : </label>

                        <div class="controls">
                            <input type="text" name="qty_per_bag" id="qty_per_bag" value="<?=(isset($data->qty_per_bag) ? $data->qty_per_bag:'')?>" class="input-xlarge focused" />
                        </div>
                    </div>
