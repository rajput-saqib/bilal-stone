            ...
            <form action="<?= $controllerName . $submitPath ?>" method="post" id="my-form" style="padding: 20px 0 0 0"
                ...
                <fieldset>
                    ...
                    <div class="control-group span6">
                        ...
                        <div class="controls">
                            <input type="text" name="date" id="date" value="<?= (isset($data->date) ? $obj->showDate($data->date) : '') ?>" class="input-xlarge datepicker hasDatepicker focused [c-e]"/>
                        </div>
                    </div>
                                                ...
                                                for ($a = 0; $a < count($data2); $a++)
                                                {
                                                    ?>
                                                        <tr class="add-more" id="add-more-<?=$a?>">
                                                            ...
                                                            <td class="center">
                                                                <input type="text" name="qty[]" id="qty-<?=$a?>" value="<?= (isset($data2[$a]->qty) ? $data2[$a]->qty : '') ?>" class="input-xlarge focused [c-e] custom-width" onkeyup="setAmount('<?=$a?>')"/>
                                                                <? if ($a == 0)
                                                                {
                                            ...
                                            else
                                            {
                                                ?>
                                                    <tr class="add-more" id="add-more-0">
                                                        ...
                                                        <td class="center">
                                                            <input type="text" name="qty[]" id="qty-0" value="" class="input-xlarge focused [c-e] custom-width" onkeyup="setAmount('0')"/>
                                                            <span class="icon32 icon-color icon-plus add-more-btn" id="add-more-btn" onclick="addMore('invoice');"> </span>
                                                        </td>
                                                    </tr>
                                                <?
