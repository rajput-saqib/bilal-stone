            ...
            <form action="<?= $controllerName . $submitPath ?>" method="post" id="my-form" style="padding: 20px 0 0 0"
                ...
                <fieldset>
                    ...
                    <div class="control-group">
                                                    ...
                                                    <tr class="add-more" id="add-more-<?=$a?>">
                                                        <td>
                                                            <div class="controls" style="margin: 0">
                                                                <select name="item[]" id="item-<?=$a?>" class="[c-e]">
                                                                    <?= $obj->selectBox_db('id', 'name', $selectBox_items, (isset($data2[$a]->item_id) ? $data2[$a]->item_id : '')) ?>
                                                                </select>
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td class="center">
                                                            ...
                                                            <? if ($a == 0)
                                                            {
                                                                ?><span class="icon32 icon-color icon-plus add-more-btn" id="add-more-btn" onclick="addMore('stock')"> </span>
                                                            <?
                                                            }
                                                            else
                                                            {
                                        ...
                                        else
                                        {
                                            ?>
                                                <tr class="add-more" id="add-more-0">
                                                    <td>
                                                        <div class="controls" style="margin: 0">
                                                            <select name="item[]" id="item-0" class="[c-e]">
                        ...
                        <?if($controller == 'employee_invoice'){?>
                        <div class="controls">
                            <div class="box-content">
                                <table class="table">
                                    <thead>
                                            ...
                                            for ($a = 0; $a < count($data2); $a++)
                                            {
                                                ?>
                                                    <tr class="add-more" id="add-more-<?=$a?>">
                                                        ...
                                                        <td class="center">
                                                            <input type="text" name="qty[]" id="qty-<?=$a?>" value="<?= (isset($data2[$a]->qty) ? $data2[$a]->qty : '') ?>" class="input-xlarge focused [c-e] custom-width" onkeyup="setTotalQty()"/>
                                                            <? if ($a == 0)
                                                            {
                                                                ?><span class="icon32 icon-color icon-plus add-more-btn" id="add-more-btn" onclick="addMore('stock-employee')"> </span>
                                                            <?
                                                            }
                                                            else
                                                            {
                                        ...
                                        else
                                        {
                                            ?>
                                                <tr class="add-more" id="add-more-0">
                                                    ...
                                                    <td class="center custom-width">&nbsp;</td>
                                                    <td class="center">
                                                        <input type="text" name="qty[]" id="qty-0" value="" class="input-xlarge focused [c-e] custom-width"  onkeyup="setTotalQty()"/>
                                                        <span class="icon32 icon-color icon-plus add-more-btn" id="add-more-btn" onclick="addMore('stock-employee');"> </span>
                                                    </td>
                                                </tr>
                                            <?
                    ...
                    <div class="control-group">
                       ...
                       <div class="control-group span6">
                           <div class="controls">
                               <span><?=($controller == 'employee_invoice') ? 'Total Quantity':'Total Amount'?> :</span>
                    ...
                    <div class="form-actions">
                        ...
                        <input type="hidden" name="type_i" id="type_i" value="<?=(isset($type_i) ? $type_i : 2)?>"/>
