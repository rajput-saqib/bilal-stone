        ...
        <div class="box-content">
            ...
            <div class="form-actions" style="padding-left : 9%">
                ...
                <?
                    $controllerEdit = '';
                    if($data->type_c == '1') {
                        $controllerEdit = 'supplier_invoice';
                    }
                    else if($data->type_c == '2')
                    {
                        $controllerEdit = 'customer_invoice';
                    }
                    else if($data->type_c == '3')
                    {
                        $controllerEdit = 'vendor_invoice';
                    }
                    else if($data->type_c == '5')
                    {
                        $controllerEdit = 'expense_invoice';
                    }

                    if($controllerEdit != '') {
                        ?><button class="btn btn-success" type="button" onclick="$('.ajax_container').hide(); callAjax('<?=$id.'|'.$data->type_i?>', '<?=ADMIN_URL.$controllerEdit?>/edit_')">Edit</button><?
                    }
